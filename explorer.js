  ...
  const CALC_TEMPLATES = [
    ...
    },
    {
      ...
      rows: [
        ...
        { label: '산출세액(70% 단일세율)', formula: '=[4]*0.7' },
    ...
    },
    {
      ...
      rows: [
        ...
        { label: '신고세액공제(3%)', formula: '=([8]-[9])*0.03' },
        { label: '납부세액', formula: '=[8]-[9]-[10]' }
      ]
    },
    {
      ...
      rows: [
        ...
        { label: '과세표준', formula: '=[1]-[11]' },
        { label: '산출세액', formula: "=누진세([12],'증여상속')" },
        { label: '기납부증여세액공제(10년내 사전증여분에 이미 낸 증여세, 없으면 0)', formula: '0' },
        { label: '신고세액공제(3%)', formula: '=([13]-[14])*0.03' },
        { label: '납부세액', formula: '=[13]-[14]-[15]' }
      ]
    }
  ];
